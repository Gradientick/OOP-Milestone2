// Sample data (shortened for brevity - use your full array here)
const employeesData = [
    {
      id: 1,
      lastName: 'Garcia',
  ...
  function addEmployeeEmails(employees) {
    return employees.map(employee => {
      // Remove spaces from first name and create email
      const cleanFirstName = employee.firstName
        .trim() // Remove whitespace from both ends
        .replace(/\s+/g, '')
        .toLowerCase(); // Remove internal spaces
      
      return {
        ...employee,
        email: `${cleanFirstName}@motorph.com`
      };
    });
  }
  
  // Usage example
  const employeesWithEmails = addEmployeeEmails(employeesData);
  
  // To verify the output
  console.log(employeesWithEmails);